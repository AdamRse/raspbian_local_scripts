...
<body>
    ...
    <!--<div id="contGraph">
        ...
        <div class="gauche">
            <div class="echelle">
                <div class="ordonnee_val">
<!--                    <div class="contVal">
                        <div class="val v1">0.00</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="droite">
            <div class="top">
                <div class="ordonnee_nom">Temperature</div>
                <div class="titre">Surveilance de la température</div>
            </div>
            <div id="graph">
                <div id="donnees">
                    <?php
                    ...
                    while($row = $logTmp->fetch_assoc()){
                        $moyenne+=$row["temperature"];
                        echo "<span id='dataTime_".$row["timestamp"]."'>".$row["temperature"]."</span>";
                    }
                    $moyenne= round($moyenne/$logTmp->num_rows, 2);
                    ?>
                </div>
            </div>
            Temps →
    ...
    <?php
    ?>
    <p>Température moyenne (dernière heure) : <?php echo affiche_temp_couleurs($moyenne) ?>°C</p>
    <p><?php echo affiche_temp_couleurs($r) ?></p>
    <h1>Monitoring</h1>
    <ul>
        <h2>Lampe</h2>
